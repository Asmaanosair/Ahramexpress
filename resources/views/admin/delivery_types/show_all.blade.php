                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title">اضافه نوع جديد </h4>
                                </div>
                                <form role="form" action="{{url('/kt_admin/add_delivery')}}" method="post" enctype="multipart/form-data" >
            ...
            <div class="containers">
                <table class="table table-striped projects text-center">
                    ...
                    @foreach($delivery as $row)
                        <form method="post" action="{{url('/kt_admin/up_delivery/'.$row->id)}}" enctype="multipart/form-data">
                            {{csrf_field()}}
                            <tr>
                                ...
                                <td>
                                    <a href="{{url('/kt_admin/del_delivery/'.$row->id)}}" class="btn btn-danger delete_item"> حذف</a>
                                </td>
