        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title text-green"> جدول الخيارات الاضافيه   </h3>
                    ...
                    <div class="modal modal-warning fade" id="modal-warning">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form role="form" action="{{url('/kt_admin/add_option')}}" method="post" enctype="multipart/form-data" >
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputPassword1" dir="rtl"> تفاصيل عنها   </label>
                                            <textarea type="text" class="form-control" name="des" id="exampleInputPassword1"  placeholder="التفاصيل "> </textarea>
                                            @if ($errors->has('des'))
                                                <span class="help-block">
            ...
            <div class="containers">
                <table class="table table-striped projects text-center">
                    ...
                    @foreach($option as $row)
                        <form method="post" action="{{url('/kt_admin/up_option/'.$row->id)}}" enctype="multipart/form-data">
                            {{csrf_field()}}
                            <tr>
                                ...
                                <td>
                                    <textarea type="text" name="des"  class="form-control" ><?php echo $row->des; ?></textarea>
                                    @if ($errors->has('des'))
                                        <span class="help-block">
                                            <strong>{{ $errors->first('des') }}</strong>
                                        </span>
                                ...
                                <td>
                                    <a href="{{url('/kt_admin/del_option/'.$row->id)}}" class="btn btn-danger delete_item"> حذف</a>
                                </td>
