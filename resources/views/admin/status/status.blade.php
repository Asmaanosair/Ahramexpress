        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title text-green"> جدول حالات الشحنات والطلبات   </h3>
                    ...
                    <div class="modal modal-warning fade" id="modal-warning">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form role="form" action="{{url('/kt_admin/add_status')}}" method="post" enctype="multipart/form-data" >
            ...
            <div class="containers">
                <table class="table table-striped projects text-center">
                    ...
                    @foreach($status as $row)
                        <form method="post" action="{{url('/kt_admin/up_status/'.$row->id)}}" enctype="multipart/form-data">
                            {{csrf_field()}}
                            <tr>
                                ...
                                <td>
                                    <a href="{{url('/kt_admin/del_status/'.$row->id)}}" class="btn btn-danger delete_item"> حذف</a>
                                </td>
