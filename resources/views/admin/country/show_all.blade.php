        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title text-green"> جدول المحافظات  </h3>
                    ...
                    <div class="modal modal-warning fade" id="modal-warning">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form role="form" action="{{url('/kt_admin/add_country')}}" method="post" enctype="multipart/form-data" >
            ...
            <div class="containers">
                <table class="table table-striped projects text-center">
                    ...
                    @foreach($country as $row)
                        <form method="post" action="{{url('/kt_admin/up_country/'.$row->id)}}" enctype="multipart/form-data">
                            {{csrf_field()}}
                            <tr>
                                ...
                                <td>
                                    <a href="{{url('/kt_admin/del_country/'.$row->id)}}" class="btn btn-danger delete_item"> حذف</a>
                                </td>
