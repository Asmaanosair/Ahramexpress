...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/v/dt/dt-1.10.18/b-1.5.6/b-flash-1.5.6/b-html5-1.5.6/datatables.min.css"/>
 
<script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/pdfmake/0.1.36/pdfmake.min.js"></script>
<script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/pdfmake/0.1.36/vfs_fonts.js"></script>
<script type="text/javascript" src="https://cdn.datatables.net/v/dt/dt-1.10.18/b-1.5.6/b-flash-1.5.6/b-html5-1.5.6/datatables.min.js"></script>
            ...
            <ul class="sidebar-menu" data-widget="tree">
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{url('/kt_admin/service')}}"><i class="fa fa-circle-o text-red"></i> Show All  </a></li>
                ...
                <li class="treeview">
                    <a href="#">
                        <i class="fa fa-files-o"></i>
                        <span>  الخيارات الاضافيه    </span>
                        <span class="pull-right-container">

            </span>
                    </a>
                    <ul class="treeview-menu">
                        <li><a href="{{url('/kt_admin/option')}}"><i class="fa fa-circle-o text-red"></i> Show All  </a></li>
                        <li><a href="{{url('/kt_admin/section')}}"><i class="fa fa-circle-o text-red"></i> الاقسام   </a></li>
                    </ul>
                </li>
                ...
                <li class="treeview">
                    <a href="#">
                        <i class="fa fa-files-o"></i>
                        <span> انواع التوصيل   </span>
                        <span class="pull-right-container">

            </span>
                    </a>
                    <ul class="treeview-menu">
                        <li><a href="{{url('/kt_admin/delivery')}}"><i class="fa fa-circle-o text-red"></i> Show All  </a></li>
                        <li><a href="{{url('/kt_admin/receive')}}"><i class="fa fa-circle-o text-red"></i> مواعيد الاستلام   </a></li>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{url('/kt_admin/vehicle')}}"><i class="fa fa-circle-o text-red"></i> Show All  </a></li>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{url('/kt_admin/weight')}}"><i class="fa fa-circle-o text-red"></i> Show All  </a></li>
                ...
                <li class="treeview">
                    <a href="#">
                        <i class="fa fa-files-o"></i>
                        <span>  المحافظات والمدن والمناطق </span>
                        <span class="pull-right-container">

            </span>
                    </a>
                    <ul class="treeview-menu">
                        <li><a href="{{url('/kt_admin/country')}}"><i class="fa fa-circle-o text-red"></i> المحافظات </a></li>
                        <li><a href="{{url('/kt_admin/city')}}"><i class="fa fa-circle-o text-red"></i> المدن  </a></li>

                        <li><a href="{{url('/kt_admin/district')}}"><i class="fa fa-circle-o text-red"></i> المناطق </a></li>
                    </ul>
                </li>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{url('/kt_admin/distance')}}"><i class="fa fa-circle-o text-red"></i> Show All  </a></li>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{url('/kt_admin/branch')}}"><i class="fa fa-circle-o text-red"></i> مشاهده الكل    </a></li>
                        <li><a href="{{url('/kt_admin/role')}}"><i class="fa fa-circle-o text-red"></i> اداره الفروع    </a></li>
                        <li><a href="{{url('/kt_admin/role')}}"><i class="fa fa-circle-o text-red"></i> الموظفين      </a></li>
                ...
                <li class="treeview">
                    <a href="#">
                        <i class="fa fa-files-o"></i>
                        <span>  اداره الفروع    </span>
                        <span class="pull-right-container">

            </span>
                    </a>
                    <ul class="treeview-menu">
                        <li><a href="{{url('/kt_admin/branch')}}"><i class="fa fa-circle-o text-red"></i> Show All  </a></li>
                  ...
                  <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{url('/kt_admin/client')}}"><i class="fa fa-circle-o text-red"></i> Show All  </a></li>
                        <li><a href="{{url('/kt_admin/c_client')}}"><i class="fa fa-circle-o text-red"></i> Add new  </a></li>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{url('/kt_admin/boy')}}"><i class="fa fa-circle-o text-red"></i>  مشاهدة الكل
                            </a></li>
                ...
                <li class="treeview">
                    <a href="#">
                        <i class="fa fa-files-o"></i>
                        <span> حالات الطلبات والشحنات   </span>
                        <span class="pull-right-container">

            </span>
                    </a>
                    <ul class="treeview-menu">
                        <li><a href="{{url('/kt_admin/status')}}"><i class="fa fa-circle-o text-red"></i>  مشاهدة الكل
                            </a></li>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{url('/kt_admin/order')}}"><i class="fa fa-circle-o text-red"></i> الطلبات   </a></li>
                        <li><a href="{{url('/kt_admin/sub_order')}}"><i class="fa fa-circle-o text-red"></i> الشحنات  </a></li>
...
{{--                    </a>--}}
{{--                    <ul class="treeview-menu">--}}
{{--                        <li><a href="{{url('/kt_admin/carear')}}"><i class="fa fa-circle-o text-red"></i> Show All  </a></li>--}}
{{--                        <li><a href="{{url('/kt_admin/c_carear')}}"><i class="fa fa-circle-o text-red"></i> Add new   </a></li>--}}
...
{{--                </li>--}}
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                <li><a href="{{url("/kt_admin/dashboard")}}"><i class="fa fa-dashboard"></i> Home</a></li>
...
<link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/v/dt/dt-1.10.18/b-1.5.6/b-flash-1.5.6/b-html5-1.5.6/b-print-1.5.6/datatables.min.css"/>
 
<script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/pdfmake/0.1.36/pdfmake.min.js"></script>
<script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/pdfmake/0.1.36/vfs_fonts.js"></script>
<script type="text/javascript" src="https://cdn.datatables.net/v/dt/dt-1.10.18/b-1.5.6/b-flash-1.5.6/b-html5-1.5.6/b-print-1.5.6/datatables.min.js"></script>
...
<script type="text/javascript" src="https://cdn.datatables.net/plug-ins/1.10.19/i18n/Arabic.json"></script>
...
<script type="text/javascript">
    $('#country').change(function(){
        ...
        if(countryID){
            $.ajax({
                type:"GET",
                url:"{{url('/kt_admin/get-state-list')}}/"+countryID,
    ...
    $('#state').on('change',function(){
        ...
        if(stateID){
            $.ajax({
                type:"GET",
                url:"{{url('/kt_admin/get-city-list')}}/"+stateID,
                success:function(res){
                    if(res){
                        $("#city").empty();
                        $.each(res,function(key,value){
